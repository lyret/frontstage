...
export async function list() {
	const runningApplicationProcesses = (await ProcessManager.list()).filter((proc) => proc.namespace == APP_DAEMON_NAMESPACE);
 ...
 * processes
 */
export async function performOperations(operations: State.Operations["applicationProcesses"]) {
